  ...
  return (
    <div className="min-h-screen flex w-full overflow-hidden selection:bg-blue-500/30" style={{ 
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{
              ...
              boxShadow: "0 0 20px rgba(244,196,78,0.45)",
              flexShrink: 0,
            }}>
            ...
            <div>
              <div style={{ color: "#1e293b", fontWeight: 700, fontSize: 15, letterSpacing: "0.08em", lineHeight: 1.2 }}>
                NEURAL ENGINE
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 2 }}>
                <span style={{ color: "#64748b", fontSize: 11, letterSpacing: "0.12em" }}>
                  QUANTUM MATCH V4.0
                </span>
                <span style={{
                  padding: "1px 8px",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid rgba(244,196,78,0.5)",
                borderRadius: 8, color: "#1e3a7a", fontSize: 12,
                cursor: "pointer", letterSpacing: "0.06em",
                transition: "all 0.2s",
                display: "flex", alignItems: "center", gap: 7,
                whiteSpace: "nowrap",
              }}
              onMouseEnter={e => { e.currentTarget.style.background = "rgba(244,196,78,0.15)"; e.currentTarget.style.borderColor = "rgba(244,196,78,0.5)"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(244,196,78,0.3)"; }}
            >
        ...
        <main id="search-main-content" className="flex-1 overflow-y-auto custom-scrollbar" style={{
          ...
          <div style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: "-10%", left: "20%", width: 600, height: 600, background: "radial-gradient(circle, rgba(244,196,78,0.12) 0%, transparent 70%)", borderRadius: "50%" }} />
            <div style={{ position: "absolute", bottom: "5%", right: "10%", width: 400, height: 400, background: "radial-gradient(circle, rgba(232,180,58,0.10) 0%, transparent 70%)", borderRadius: "50%" }} />
            ...
            <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.04 }}>
              <defs><pattern id="grid" width="60" height="60" patternUnits="userSpaceOnUse"><path d="M 60 0 L 0 0 0 60" fill="none" stroke="#f4c44e" strokeWidth="0.5" /></pattern></defs>
              <rect width="100%" height="100%" fill="url(#grid)" />
            </svg>
            {/* Floating particles */}
            {particles.map((p: any) => (
              <div key={p.id} style={{ position: "absolute", left: `${p.x}%`, top: `${p.y}%`, width: p.size, height: p.size, borderRadius: "50%", background: "#f4c44e", opacity: p.opacity }} />
            ))}
          </div>
          ...
          <section style={{ maxWidth: 900, margin: "0 auto", padding: "70px 40px 60px", position: "relative", zIndex: 5 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "7px 18px", background: "rgba(244,196,78,0.1)", border: "1px solid rgba(244,196,78,0.25)", borderRadius: 100, fontSize: 11, letterSpacing: "0.14em", color: "#1e3a7a" }}>
            ...
            <p style={{ textAlign: "center", color: "#64748b", fontSize: 15, lineHeight: 1.7, maxWidth: 560, margin: "0 auto 50px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 0, marginBottom: 50 }}>
              {[
                ...
                <div key={i} style={{ textAlign: "center", padding: "0 40px", borderRight: i < arr.length - 1 ? "1px solid rgba(0,0,0,0.1)" : "none", flex: 1 }}>
                  <div style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 800, color: "#1e293b", lineHeight: 1.1 }}>{s.value}</div>
                  <div style={{ color: "#64748b", fontSize: 11, letterSpacing: "0.12em", marginTop: 4 }}>{s.label.toUpperCase()}</div>
                </div>
              ))}
            </div>

            {/* Search card */}
            <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 20, padding: "32px", boxShadow: "0 4px 24px rgba(0,0,0,0.07)" }}>
              {/* Search bar */}
              <div style={{ display: "flex", gap: 12, marginBottom: 28, flexWrap: "wrap" }}>
                <div style={{ flex: "1 1 300px", position: "relative", display: "flex", alignItems: "center" }}>
                  ...
                  <input
                    ...
                    style={{ width: "100%", padding: "16px 16px 16px 46px", background: "#f8fafc", border: "1px solid rgba(0,0,0,0.12)", borderRadius: 12, color: "#1e293b", fontSize: 14, outline: "none", transition: "border-color 0.2s", boxSizing: "border-box" }}
                    onFocusCapture={e => e.target.style.borderColor = "rgba(244,196,78,0.6)"}
                    onBlurCapture={e => {
                      e.target.style.borderColor = "rgba(244,196,78,0.25)";
                    ...
                    <div style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, padding: "0 8px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                           <Sparkles size={16} color="#f4c44e" />
                           <span style={{ fontSize: 12, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.2em", color: "#1e293b" }}>Recommended Scans</span>
                        </div>
                      </div>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                        {POPULAR_SEARCHES.map(s => (
                          <button 
                            ...
                            onMouseOver={e => { e.currentTarget.style.background = "rgba(244,196,78,0.3)"; e.currentTarget.style.borderColor = "rgba(244,196,78,0.5)"; }}
                            onMouseOut={e => { e.currentTarget.style.background = "rgba(0,0,0,0.03)"; e.currentTarget.style.borderColor = "rgba(0,0,0,0.08)"; }}
                          >
                            {s}
                          </button>
                        ))}
                ...
                <button
                  ...
                  style={{
                    padding: "16px 28px",
                    background: (scanning || loading) ? "rgba(244,196,78,0.3)" : "linear-gradient(135deg, #f4c44e, #8b5cf6)",
                    border: "none", borderRadius: 12, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer", whiteSpace: "nowrap", letterSpacing: "0.06em", transition: "all 0.3s", boxShadow: (scanning || loading) ? "none" : "0 0 30px rgba(244,196,78,0.4)", display: "flex", alignItems: "center", gap: 8,
              ...
              {(scanning || loading) && (
                <div style={{ marginBottom: 20 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                    ...
                    <span style={{ fontSize: 11, color: "#1e3a7a", fontWeight: 600 }}>{Math.round(scanProgress)}%</span>
                  </div>
                  <div style={{ height: 3, background: "rgba(244,196,78,0.15)", borderRadius: 100, overflow: "hidden" }}>
                    <div style={{ height: "100%", borderRadius: 100, background: "linear-gradient(90deg, #f4c44e, #a78bfa)", width: `${scanProgress}%`, transition: "width 0.1s", boxShadow: "0 0 10px rgba(244,196,78,0.6)" }} />
                  </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="3.5"
                    style={{ width: "100%", padding: "12px 14px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(244,196,78,0.2)", borderRadius: 10, color: "#e2e8f0", fontSize: 13, outline: "none", boxSizing: "border-box" }}
                    onFocusCapture={e => e.target.style.borderColor = "rgba(244,196,78,0.5)"}
                    onBlurCapture={e => e.target.style.borderColor = "rgba(244,196,78,0.2)"}
                  />
                </div>
              </div>
            </div>
            ...
            <div style={{ marginTop: 20 }}>
              <button
                ...
                style={{
                  ...
                  background: (scanning || loading) ? "rgba(244,196,78,0.2)" : "linear-gradient(135deg, #e8b43a 0%, #d4a017 100%)",
                  border: (scanning || loading) ? "1px solid rgba(244,196,78,0.4)" : "none",
                  borderRadius: 16, color: "#fff", fontSize: 15, fontWeight: 700, letterSpacing: "0.1em", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 12, transition: "all 0.3s", boxShadow: (scanning || loading) ? "none" : "0 4px 40px rgba(244,196,78,0.35)",
                }}
              >
            ...
            {/* Bottom hint */}
            <p style={{ textAlign: "center", color: "rgba(244,196,78,0.35)", fontSize: 12, marginTop: 20, letterSpacing: "0.06em" }}>
          ...
          <div className="px-8 pb-32 max-w-7xl mx-auto">
            ...
            {loading ? (
              ...
              <div style={{
                ...
                border: "1px solid rgba(244,196,78,0.15)", 
                borderRadius: "32px", padding: "80px 40px", 
                textAlign: "center", maxWidth: 700, margin: "0 auto", 
                boxShadow: "0 0 80px rgba(244,196,78,0.05)"
              }}>
                <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 400, height: 400, background: "radial-gradient(circle, rgba(244,196,78,0.08) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
                
                <div style={{ width: 80, height: 80, margin: "0 auto 32px", background: "linear-gradient(135deg, rgba(244,196,78,0.15), rgba(232,180,58,0.05))", borderRadius: "24px", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(244,196,78,0.3)", position: "relative" }}>
                   <div style={{ position: "absolute", inset: -2, borderRadius: "26px", border: "1px solid rgba(244,196,78,0.3)", opacity: 0.5, animation: "ping 2s cubic-bezier(0, 0, 0.2, 1) infinite" }} />
                   <Search size={32} color="#f4c44e" style={{ filter: "drop-shadow(0 0 10px rgba(129,140,248,0.5))" }} />
                </div>
                
                <h3 style={{ fontSize: 28, fontWeight: 800, margin: "0 0 16px 0", color: "#fff", letterSpacing: "-0.02em" }}>No Neural Matches Found</h3>
                
                <p style={{ color: "#64748b", fontSize: 15, lineHeight: 1.6, maxWidth: 440, margin: "0 auto 40px" }}>
                ...
                <button
                  ...
                  style={{ 
                    ...
                    color: "#1e3a7a", fontSize: 12, fontWeight: 800, 
                    textTransform: "uppercase", letterSpacing: "0.15em", 
                    cursor: "pointer", transition: "all 0.3s", 
                    display: "inline-flex", alignItems: "center", gap: 12 
                  }}
                  onMouseOver={e => { e.currentTarget.style.background = "rgba(244,196,78,0.2)"; e.currentTarget.style.color = "#fff"; e.currentTarget.style.borderColor = "rgba(244,196,78,0.5)"; }}
                  onMouseOut={e => { e.currentTarget.style.background = "rgba(244,196,78,0.1)"; e.currentTarget.style.color = "#a5b4fc"; e.currentTarget.style.borderColor = "rgba(244,196,78,0.3)"; }}
                >
              ...
              <div className={viewMode === 'grid' ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" : "space-y-6"}>
                ...
                {scholarships.map((s) => {
                  ...
                  const matchColor = score >= 80 ? '#10b981' : score >= 60 ? '#f59e0b' : '#f4c44e';
                  ...
                  <div
                    ...
                    style={{
                      background: '#ffffff',
                      border: isSaved ? '1px solid rgba(16,185,129,0.4)' : '1px solid rgba(244,196,78,0.2)',
                      borderRadius: 20,
                      overflow: 'hidden',
                      boxShadow: isSaved ? '0 4px 20px rgba(16,185,129,0.12)' : '0 2px 12px rgba(0,0,0,0.08)',
                  ...
                  >
                    {/* Top accent bar */}
                    <div style={{ height: 3, background: isSaved ? 'linear-gradient(90deg,#10b981,#34d399)' : 'linear-gradient(90deg,#e8b43a,#f4c44e,#f4c44e)' }} />

                    {/* Card Header */}
                    <div style={{ padding: '16px 20px 14px', background: 'rgba(244,196,78,0.04)', borderBottom: '1px solid rgba(0,0,0,0.06)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <h3 style={{ fontSize: 15, fontWeight: 800, color: '#1e293b', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 6 }}>
                          {s.title}
                        </h3>
                        {/* Meta chips */}
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                          {s.university_name && (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, background: '#f8fafc', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 8, padding: '3px 8px', fontSize: 10, fontWeight: 700, color: '#64748b' }}>
                          ...
                          {s.degree_level && (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, background: 'rgba(244,196,78,0.1)', border: '1px solid rgba(244,196,78,0.25)', borderRadius: 8, padding: '3px 8px', fontSize: 10, fontWeight: 700, color: '#1e3a7a' }}>
                              {s.degree_level}
                            </span>
                          )}
                          {s.funding_type && (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, background: 'rgba(232,180,58,0.1)', border: '1px solid rgba(232,180,58,0.25)', borderRadius: 8, padding: '3px 8px', fontSize: 10, fontWeight: 700, color: '#1e3a7a' }}>
                              {s.funding_type}
                            </span>
                          )}
                        </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                        ...
                        <button
                          ...
                          style={{ background: isSaved ? 'rgba(16,185,129,0.1)' : '#f8fafc', border: isSaved ? '1px solid rgba(16,185,129,0.3)' : '1px solid rgba(0,0,0,0.1)', borderRadius: 10, padding: '7px 10px', cursor: 'pointer', color: isSaved ? '#10b981' : '#64748b', fontSize: 10, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4, transition: 'all 0.2s' }}
                        >
                    ...
                    <div style={{ padding: '12px 20px', display: 'flex', gap: 10 }}>
                      ...
                      <div style={{ flex: 1, background: dlBg, border: `1px solid ${dlBorder}`, borderRadius: 12, padding: '10px 14px' }}>
                        ...
                        <div style={{ fontSize: 13, fontWeight: 900, color: '#1e293b' }}>{dlFormatted}</div>
                      </div>
                    </div>
                    ...
                    {/* Footer */}
                    <div style={{ padding: '12px 20px', background: 'rgba(244,196,78,0.03)', borderTop: '1px solid rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto' }}>
                      <div style={{ display: 'flex', gap: 6 }}>
                        <span style={{ background: 'rgba(244,196,78,0.1)', border: '1px solid rgba(244,196,78,0.25)', borderRadius: 8, padding: '4px 10px', fontSize: 9, fontWeight: 800, color: '#1e3a7a', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                      ...
                      <button
                        ...
                        style={{ background: 'linear-gradient(135deg,#e8b43a,#f4c44e)', border: 'none', borderRadius: 12, padding: '10px 20px', color: '#1e3a7a', fontSize: 11, fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, letterSpacing: '0.05em', boxShadow: '0 4px 16px rgba(244,196,78,0.35)', transition: 'all 0.2s' }}
                ...
                {totalPages > 1 && (
                  <div className="flex flex-wrap justify-center items-center gap-4 mt-20 pb-12">
                    ...
                    <div className="flex items-center gap-2 px-8 py-4 bg-white rounded-2xl font-black border border-gray-200">
      ...
      <style>{`
        ...
        .shimmer-text {
          background: linear-gradient(90deg, #3b82f6, #f4c44e, #9333ea, #3b82f6);
        ...
        .skeleton-shimmer {
          background: linear-gradient(90deg, rgba(255,255,255,0.03) 25%, rgba(0,0,0,0.05) 50%, rgba(255,255,255,0.03) 75%);
