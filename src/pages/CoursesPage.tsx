...
import { BookOpen, Search, Clock, Users, Star, ChevronRight, Play, CheckCircle, Zap, Award, GraduationCap, Briefcase, User, ArrowRight, DollarSign, X, Loader2, CreditCard, Smartphone, Building2 } from "lucide-react";
          ...
          <div className="flex gap-2">
            <button
              ...
              style={{
                ...
                color: activeTab === "courses" ? "#ffffff" : "#6b7280",
              }}
            >
              <BookOpen size={16} />
            ...
            <button
              ...
              style={{
                ...
                color: activeTab === "teachers" ? "#ffffff" : "#6b7280",
              }}
            >
        ...
        {activeTab === "teachers" && (
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-gray-900">Expert Test Prep Teachers</h2>
                <p className="text-sm text-gray-500">Learn from certified instructors with years of experience</p>
              </div>
              {filter !== "All" && (
                <span className="px-3 py-1 rounded-full text-xs font-bold" style={{ backgroundColor: `${TEST_COLORS[filter]}20`, color: TEST_COLORS[filter] }}>
                  {filter} Teachers
                </span>
              )}
            </div>
            ...
            {filteredTeachers.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
                ...
                <h3 className="text-gray-700 font-bold mb-1">No teachers found</h3>
                <p className="text-gray-400 text-sm">
                  {filter !== "All" ? `No approved ${filter} teachers yet.` : "Teachers will appear here once approved by admin."}
                </p>
              </div>
            ) : (
              <div className="grid md:grid-cols-2 gap-5">
                {filteredTeachers.map((teacher) => (
                  <div
                    ...
                    className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer"
                  ...
                  >
                    ...
                    <div className="px-5 relative">
                      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center text-white text-2xl font-bold shadow-lg -mt-10 border-4 border-white overflow-hidden">
                    ...
                    <div className="p-5 pt-3">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2 mb-3">
                        {teacher.specializations?.split(",").map((spec: string, i: number) => (
                          <span
                            ...
                            style={{
                              backgroundColor: `${TEST_COLORS[spec.trim()] || "#6366f1"}15`,
                              color: TEST_COLORS[spec.trim()] || "#6366f1",
                            }}
                          >
                            {spec.trim()}
                          </span>
                      ...
                      <p className="text-sm text-gray-500 line-clamp-2 mb-4">
                        {teacher.bio || `${teacher.name} is an experienced test prep instructor helping students achieve their dream scores.`}
                      </p>
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-400 mb-4">
                        <span className="flex items-center gap-1">
                          <Briefcase size={12} />
                          {teacher.experience_years || 1}+ years
                        </span>
                        <span className="flex items-center gap-1">
                          <BookOpen size={12} />
                          {teacher.total_courses || 0} courses
                        </span>
                        <span className="flex items-center gap-1">
                          <Users size={12} />
                      ...
                      {teacher.courses?.length > 0 && (
                        <div className="border-t border-gray-100 pt-3">
                          <p className="text-xs text-gray-400 mb-2">Available Courses:</p>
                          <div className="flex flex-wrap gap-1">
                            {teacher.courses.slice(0, 3).map((c: any) => (
                              <span
                                ...
                                style={{
                                  backgroundColor: `${TEST_COLORS[c.test_type] || "#6366f1"}10`,
                                  color: TEST_COLORS[c.test_type] || "#6366f1",
                                }}
                              >
                                {c.test_type}
                              </span>
                      ...
                      <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
                        <span className="text-xs text-gray-400">View full profile & courses</span>
                        <span className="flex items-center gap-1 text-violet-600 text-sm font-bold">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    {c.enrolled ? (
                      ...
                      <span className="flex items-center gap-1 text-indigo-500 text-xs font-bold">
                        <Loader2 size={11} className="animate-spin" />Enrolling...
                      </span>
                    ) : (
                      <button
                        onClick={(e) => {
                        ...
                        className="flex items-center gap-1 text-indigo-500 text-xs font-bold group-hover:gap-2 transition-all hover:text-indigo-700"
                      >
                        {c.price > 0 ? (
                          <><DollarSign size={11} />Buy Now</>
                        ) : (
                          <><CheckCircle size={11} />Enroll Free</>
                        )}
                      </button>
                    )}
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-violet-600 p-6 text-white">
              ...
              <div className="mt-4 flex items-center gap-2">
                <span className="text-3xl font-black">PKR {selectedCourse.price?.toLocaleString()}</span>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
                ...
                <ol className="text-sm text-gray-600 space-y-1.5 list-decimal list-inside">
                  {paymentMethod === "JazzCash" && (
                    <>
                      ...
                      <li>Send money to teacher's JazzCash account</li>
                  ...
                  {paymentMethod === "Easypaisa" && (
                    <>
                      ...
                      <li>Send money to teacher's Easypaisa account</li>
                      <li>Enter the reference number below</li>
                    </>
                  )}
                  {paymentMethod === "Bank" && (
                    <>
                      <li>Transfer to teacher's bank account</li>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1.5">
                  This helps the teacher verify your payment
                </p>
              </div>
            </div>
